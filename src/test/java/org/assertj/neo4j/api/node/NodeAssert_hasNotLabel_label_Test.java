...
/**
 * Checks <code>{@link org.assertj.neo4j.api.NodeAssert#hasNotLabel(org.neo4j.graphdb.Label)}</code> behavior.
 * 
 * @author Florent Biville
 */
public class NodeAssert_hasNotLabel_label_Test {
  ...
  public void should_pass_hasNotLabel_if_node_has_not_label() {
    ...
    assertThat(node).hasNotLabel(DynamicLabel.label("REPTILE"));
  }
  ...
  public void should_fail_hasNotLabel_if_node_is_null() {
    ...
    assertThat((Node) null).hasNotLabel(DynamicLabel.label("LABEL"));
  }
  ...
  public void should_fail_hasNotLabel_if_label_value_is_null() {
    ...
    assertThat(node).hasNotLabel((Label) null);
  }
