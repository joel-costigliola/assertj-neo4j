...
/**
 * Checks <code>{@link org.assertj.neo4j.api.RelationshipAssert#doesNotHaveType(org.neo4j.graphdb.RelationshipType)}</code>
 * behavior.
 * 
...
public class RelationshipAssert_doesNotHaveType_Test {
  ...
  public void should_fail_if_given_relationship_type_is_null() {
    ...
    assertThat(relationship).doesNotHaveType(null);
  }
