...
class ShouldEntityHavePropertyInstanceOfTests {
    ...
    class CreateTests {
        ...
        void should_generate_error_message() {
            // GIVEN
            final DbNode actual = Entities.node().id(1).property("key", "value-1").build();
    ...
    class ElementsTests {
        ...
        void should_generate_an_aggregate_error_message() {
            ...
            final DbNode node3 = Entities.node().id(3).property("key", 3.14).build();
            final DbNode node4 = Entities.node().id(4).property("key", 4).build();
