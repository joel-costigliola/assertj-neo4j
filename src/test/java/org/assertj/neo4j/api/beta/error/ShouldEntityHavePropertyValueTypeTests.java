 ...
 */
class ShouldEntityHavePropertyValueTypeTests {
    ...
    class CreateTests {
        ...
        void should_generate_error_message() {
            ...
            final DbNode actual = Entities.node().id(2).property("key", Samples.LOCAL_DATE_TIME).build();

            // WHEN
            final ErrorMessageFactory result = ShouldEntityHavePropertyValueType.create(actual, "key", expectedType);
    ...
    class ElementsTests {
        ...
        void should_generate_an_aggregate_error_message() {
            ...
            // WHEN
            final ErrorMessageFactory error = ShouldEntityHavePropertyValueType
