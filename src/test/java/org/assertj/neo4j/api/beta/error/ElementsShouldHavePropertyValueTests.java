 ...
 */
class ElementsShouldHavePropertyValueTests {
    ...
    void single_entities_error() {
        ...
        // WHEN
        final ErrorMessageFactory result = ElementsShouldHavePropertyValue
                .create(RecordType.NODE, actual, actual, "toto", "toto");
