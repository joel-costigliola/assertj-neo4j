...
/**
 * Checks <code>{@link org.assertj.neo4j.api.PathAssert#hasEnd(org.neo4j.graphdb.Node)}</code> behavior.
 * 
 * @author Florent Biville
 */
public class PathAssert_hasEnd_Test {
  ...
  public void should_fail_hasEnd_if_relationship_is_null() {
    ...
    assertThat((Path) null).hasEnd(mock(Node.class));
  }
  ...
  public void should_fail_hasEnd_if_relationship_end_node_is_null() {
    ...
    assertThat(path).hasEnd(mock(Node.class));
  }
  ...
  public void should_fail_hasEnd_if_passed_end_node_is_null() {
    ...
    assertThat(path).hasEnd((Node) null);
  }
