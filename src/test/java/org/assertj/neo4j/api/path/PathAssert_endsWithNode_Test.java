...
/**
 * Checks <code>{@link org.assertj.neo4j.api.PathAssert#endsWithNode(org.neo4j.graphdb.Node)}</code> behavior.
 * 
 * @author Florent Biville
 */
public class PathAssert_endsWithNode_Test {
  ...
  public void should_pass_if_path_ends_with_node() {
    ...
    assertThat(path).endsWithNode(node);
  }
  ...
  public void should_fail_if_path_is_null() {
    ...
    assertThat((Path) null).endsWithNode(mock(Node.class));
  }
  ...
  public void should_fail_if_path_end_node_is_null() {
    ...
    assertThat(path).endsWithNode(mock(Node.class));
  }
