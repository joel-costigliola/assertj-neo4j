...
public class ExecutionResultAssert_containsAtRow_Test {
  ...
  public void should_pass_if_given_rows_contain_entries() {
    ...
    assertThat(executionResult).containsAtRow(0, entry("firstName", "Florent")).containsAtRow(1,
        entry("lastName", "Biville"));
  }
  ...
  public void should_fail_if_given_row_index_is_not_specified_in_increasing_order() {
    ...
    assertThat(executionResult).containsAtRow(1, entry("firstName", "Florent")).containsAtRow(0,
        entry("lastName", "Biville"));
  }
