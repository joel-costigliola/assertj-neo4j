...
class ExecutionResultAssertTestUtils {
   ...
   * 
   * 1 initial call of hasNext (true) + 5 subsequent calls (4 true and 1 false) assertThat(executionResult)
   * .containsColumnNamesAtRow(0, "foo", "bar") // calls hasNext for element 0 and 1 .containsColumnNamesAtRow(1, "foo",
   * "bar") // calls hasNext for element 1 and 2 .containsColumnNamesAtRow(2, "foo", "bar") // calls hasNext for element
   * 2 and 3
   * 
   * 1 initial call of hasNext (true) + 3 subsequent calls (2 true and 1 false) assertThat(executionResult)
