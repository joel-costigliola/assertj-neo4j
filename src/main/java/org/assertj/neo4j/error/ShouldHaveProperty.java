...
public class ShouldHaveProperty extends BasicErrorMessageFactory {
   ...
   */
  public static ErrorMessageFactory shouldHaveProperty(PropertyContainer actual, String key) {
    return new ShouldHaveProperty(actual, key, StandardComparisonStrategy.instance());
  }

  private ShouldHaveProperty(PropertyContainer actual, String other, ComparisonStrategy comparisonStrategy) {
