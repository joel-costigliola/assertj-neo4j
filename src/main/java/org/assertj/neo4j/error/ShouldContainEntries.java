...
public class ShouldContainEntries extends BasicErrorMessageFactory {
   ...
   */
  public static ErrorMessageFactory shouldContainEntries(Result actual, int rowIndex, Map<String, Object> row,
                                                         MapEntry[] entries, Collection<MapEntry> notFound) {
    return new ShouldContainEntries(actual, rowIndex, row, entries, notFound);
  }

  private ShouldContainEntries(Result actual, int rowIndex, Map<String, Object> row, MapEntry[] entries,
