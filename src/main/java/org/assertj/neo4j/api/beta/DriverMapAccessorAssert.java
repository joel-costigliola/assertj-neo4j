...
/**
 * Assertions for Neo4J {@link MapAccessor}
 *
 * @author patouche
 */
public class DriverMapAccessorAssert<A extends DriverMapAccessorAssert<A, T>, T extends MapAccessor>
    extends AbstractAssert<A, T> {

    protected DriverMapAccessorAssert(T actual, Class<? extends A> assertClass) {
     ...
     * @return this {@link DriverMapAccessorAssert} for assertions chaining
