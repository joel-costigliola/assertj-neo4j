...
public class IndexDefinitionAssert extends AbstractAssert<IndexDefinitionAssert, IndexDefinition> {
   ...
   * IndexDefinition indexDefinition = graph.schema().indexFor(Label.label(&quot;War Machine&quot;))
   * .on(&quot;name&quot;).create();
   *
   ...
   * <pre>
   * GraphDatabaseService graph = new TestGraphDatabaseFactory().newImpermanentDatabase();
   * IndexDefinition indexDefinition = graph.schema().indexFor(Label.label(&quot;Spiderman&quot;))
   * .on(&quot;name&quot;).create();
   *
